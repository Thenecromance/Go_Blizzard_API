...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/DataService/Heirloom"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/heirloom/index", ginwowHeirloomIndex) /* HeirloomIndex Returns an index of heirlooms. */

	app.Instance().RegisterRoute("GET", "/data/wow/heirloom/:heirloomId", ginwowHeirloom) /* Heirloom Returns an heirloom by id. */

}

func ginwowHeirloomIndex(c *gin.Context) {
...
func ginwowHeirloom(c *gin.Context) {
	// binding uri parameters
