...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/professions", ginCharacterProfessionsSummary) //CharacterProfessionsSummary Returns a summary of professions for a character.
