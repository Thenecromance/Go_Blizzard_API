...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/StarCraftII/Community/Account"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/sc2/player/:accountId", ginStarCraftIIPlayer) /* Player Returns metadata for an individual's account. */

}

func ginStarCraftIIPlayer(c *gin.Context) {
