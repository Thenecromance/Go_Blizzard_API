...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/ProfileService/CharacterTitles"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/titles", ginwowCharacterTitlesSummary) /* CharacterTitlesSummary Returns a summary of titles a character has obtained. */

}

func ginwowCharacterTitlesSummary(c *gin.Context) {
