...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/DataService/PlayableSpecialization"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/playable-specialization/index", ginwowPlayableSpecializationsIndex) /* PlayableSpecializationsIndex Returns an index of playable specializations. */

	app.Instance().RegisterRoute("GET", "/data/wow/playable-specialization/:specId", ginwowPlayableSpecialization) /* PlayableSpecialization Returns a playable specialization by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/media/playable-specialization/:specId", ginwowPlayableSpecializationMedia) /* PlayableSpecializationMedia Returns media for a playable specialization by ID. */

}

func ginwowPlayableSpecializationsIndex(c *gin.Context) {
...
func ginwowPlayableSpecialization(c *gin.Context) {
	// binding uri parameters
...
func ginwowPlayableSpecializationMedia(c *gin.Context) {
	// binding uri parameters
