...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/DataService/Toy"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/toy/index", ginwowToyIndex) /* ToyIndex Returns an index of toys. */

	app.Instance().RegisterRoute("GET", "/data/wow/toy/:toyId", ginwowToy) /* Toy Returns a toy by id. */

}

func ginwowToyIndex(c *gin.Context) {
