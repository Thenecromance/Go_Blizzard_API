...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/profession/index", ginwowProfessionsIndex) /* ProfessionsIndex Returns an index of professions. */

	app.Instance().RegisterRoute("GET", "/data/wow/profession/:professionId", ginwowProfession) /* Profession Returns a profession by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/media/profession/:professionId", ginwowProfessionMedia) /* ProfessionMedia Returns media for a profession by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/profession/:professionId/skill-tier/:skillTierId", ginwowProfessionSkillTier) /* ProfessionSkillTier Returns a skill tier for a profession by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/recipe/:recipeId", ginwowRecipe) /* Recipe Returns a recipe by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/media/recipe/:recipeId", ginwowRecipeMedia) /* RecipeMedia Returns media for a recipe by ID. */
