...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/DataService/MythicKeystoneAffix"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/keystone-affix/index", ginwowMythicKeystoneAffixesIndex) /* MythicKeystoneAffixesIndex Returns an index of mythic keystone affixes. */

	app.Instance().RegisterRoute("GET", "/data/wow/keystone-affix/:keystoneAffixId", ginwowMythicKeystoneAffix) /* MythicKeystoneAffix Returns a mythic keystone affix by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/media/keystone-affix/:keystoneAffixId", ginwowMythicKeystoneAffixMedia) /* MythicKeystoneAffixMedia Returns media for a mythic keystone affix by ID. */

}

func ginwowMythicKeystoneAffixesIndex(c *gin.Context) {
...
func ginwowMythicKeystoneAffix(c *gin.Context) {
	// binding uri parameters
...
func ginwowMythicKeystoneAffixMedia(c *gin.Context) {
	// binding uri parameters
