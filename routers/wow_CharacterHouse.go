...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/ProfileService/CharacterHouse"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/house/house-{houseNumber}", ginwowCharacterHouseSummary) /* CharacterHouseSummary Returns a summary of a house a character has built. */

}

func ginwowCharacterHouseSummary(c *gin.Context) {
