...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/ProfileService/CharacterSoulbinds"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/soulbinds", ginwowCharacterSoulbinds) /* CharacterSoulbinds Returns a character's soulbinds. */

}

func ginwowCharacterSoulbinds(c *gin.Context) {
