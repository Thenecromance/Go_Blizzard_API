...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/DataService/Title"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/title/index", ginwowTitlesIndex) /* TitlesIndex Returns an index of titles. */

	app.Instance().RegisterRoute("GET", "/data/wow/title/:titleId", ginwowTitle) /* Title Returns a title by ID. */

}

func ginwowTitlesIndex(c *gin.Context) {
...
func ginwowTitle(c *gin.Context) {
	// binding uri parameters
