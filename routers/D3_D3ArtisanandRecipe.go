...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/D3/Community/D3ArtisanandRecipe"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/d3/data/artisan/:artisanSlug", ginD3GetArtisan) /* GetArtisan Returns a single artisan by slug. */

	app.Instance().RegisterRoute("GET", "/d3/data/artisan/:artisanSlug/recipe/:recipeSlug", ginD3GetRecipe) /* GetRecipe Returns a single recipe by slug for the specified artisan. */

}

func ginD3GetArtisan(c *gin.Context) {
...
func ginD3GetRecipe(c *gin.Context) {
	// binding uri parameters
