...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/StarCraftII/Community/Ladder"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/sc2/ladder/grandmaster/:regionId", ginStarCraftIIGrandmasterLeaderboard) /* GrandmasterLeaderboard Returns ladder data for the current season's grandmaster leaderboard. */

	app.Instance().RegisterRoute("GET", "/sc2/ladder/season/:regionId", ginStarCraftIISeason) /* Season Returns data about the current season. */

}

func ginStarCraftIIGrandmasterLeaderboard(c *gin.Context) {
...
func ginStarCraftIISeason(c *gin.Context) {
	// binding uri parameters
