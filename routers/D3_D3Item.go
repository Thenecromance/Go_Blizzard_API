...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/D3/Community/D3Item"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/d3/data/item/:itemSlugAndId", ginD3GetItem) /* GetItem Returns a single item by item slug and ID. */

}

func ginD3GetItem(c *gin.Context) {
