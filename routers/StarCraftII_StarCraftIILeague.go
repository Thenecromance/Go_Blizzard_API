...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/StarCraftII/DataService/StarCraftIILeague"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/sc2/league/:seasonId/:queueId/:teamType/:leagueId", ginStarCraftIIGetLeagueData) /* GetLeagueData Returns data for the specified season, queue, team, and league.
...
func ginStarCraftIIGetLeagueData(c *gin.Context) {
