...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/ProfileService/CharacterProfessions"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/professions", ginwowCharacterProfessionsSummary) /* CharacterProfessionsSummary Returns a summary of professions for a character. */

}

func ginwowCharacterProfessionsSummary(c *gin.Context) {
