...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/DataService/PvPTier"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/data/wow/pvp-tier/index", ginwowPvPTiersIndex) /* PvPTiersIndex Returns an index of PvP tiers. */

	app.Instance().RegisterRoute("GET", "/data/wow/pvp-tier/:pvpTierId", ginwowPvPTier) /* PvPTier Returns a PvP tier by ID. */

	app.Instance().RegisterRoute("GET", "/data/wow/media/pvp-tier/:pvpTierId", ginwowPvPTierMedia) /* PvPTierMedia Returns media for a PvP tier by ID. */

}

func ginwowPvPTiersIndex(c *gin.Context) {
...
func ginwowPvPTier(c *gin.Context) {
	// binding uri parameters
...
func ginwowPvPTierMedia(c *gin.Context) {
	// binding uri parameters
