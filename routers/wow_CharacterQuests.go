...
import (
	...
	"github.com/Thenecromance/Go_Blizzard_API/api/wow/ProfileService/CharacterQuests"
...
func init() {
	...
	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/quests", ginwowCharacterQuests) /* CharacterQuests Returns a character's active quests as well as a link to the character's completed quests. */

	app.Instance().RegisterRoute("GET", "/profile/wow/character/:realmSlug/:characterName/quests/completed", ginwowCharacterCompletedQuests) /* CharacterCompletedQuests Returns a list of quests that a character has completed. */

}

func ginwowCharacterQuests(c *gin.Context) {
...
func ginwowCharacterCompletedQuests(c *gin.Context) {
	// binding uri parameters
