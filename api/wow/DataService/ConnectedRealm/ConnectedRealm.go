...
// CNHookConnectedRealmSearch allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookConnectedRealmSearch func(context.Context, *ConnectedRealmSearchFields) (any, error)

// StringConnectedRealmSearch executes the request and returns the raw response body string.
func StringConnectedRealmSearch(ctx context.Context, fields *ConnectedRealmSearchFields) (string, error) {
	if fields == nil {
		fields = &ConnectedRealmSearchFields{}
	}

	// 1. Initialize Request Metadata
	fields.RequestMethod = utils.GetApiConfig("ConnectedRealmSearch")
	if fields.RequestMethod.Path == "" {
		fields.RequestMethod = utils.RequestMethod{
			Methods:  "GET",
...
func bridgeConnectedRealmSearch(ctx context.Context, fields *ConnectedRealmSearchFields) (any, error) {
	...
	// 2. Default: Use Global/Standard logic
	objString, err := StringConnectedRealmSearch(ctx, fields)
	if err != nil {
		return nil, err
	}
