...
// CNHookToyIndex allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookToyIndex func(context.Context, *ToyIndexFields) (any, error)

// StringToyIndex executes the request and returns the raw response body string.
func StringToyIndex(ctx context.Context, fields *ToyIndexFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("ToyIndex")
...
func bridgeToyIndex(ctx context.Context, fields *ToyIndexFields) (any, error) {
	...
	if fields.CN != nil {
		...
		if CNHookToyIndex != nil {
			return CNHookToyIndex(ctx, fields)
		}
	...
	objString, err := StringToyIndex(ctx, fields)
	if err != nil {
		return nil, err
	}
...
type ToyFields struct {
	ToyId int `uri:"toyId" binding:"required"` // The ID of the toy.
		Namespace string `form:"namespace,default=static-us"` // The namespace to use to locate this document.
	Locale string `form:"locale,default=en_US"` // The locale to reflect in localized data.
...
// CNHookToy allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookToy func(context.Context, *ToyFields) (any, error)

// StringToy executes the request and returns the raw response body string.
func StringToy(ctx context.Context, fields *ToyFields) (string, error) {
	...
	// 1. Initialize Request Metadata
	fields.RequestMethod = utils.GetApiConfig("Toy")
	if fields.RequestMethod.Path == "" {
		fields.RequestMethod = utils.RequestMethod{
			Methods:  "GET",
...
func bridgeToy(ctx context.Context, fields *ToyFields) (any, error) {
	...
	// 2. Default: Use Global/Standard logic
	objString, err := StringToy(ctx, fields)
	if err != nil {
		return nil, err
	}
