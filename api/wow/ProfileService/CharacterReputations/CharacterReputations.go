...
// ==============================================================================================
// API: CharacterReputationsSummary
// ==============================================================================================
...
// CNHookCharacterReputationsSummary allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookCharacterReputationsSummary func(context.Context, *CharacterReputationsSummaryFields) (any, error)

// StringCharacterReputationsSummary executes the request and returns the raw response body string.
func StringCharacterReputationsSummary(ctx context.Context, fields *CharacterReputationsSummaryFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("CharacterReputationsSummary")
...
// bridgeCharacterReputationsSummary routes the request to either CN or Global logic based on input.
func bridgeCharacterReputationsSummary(ctx context.Context, fields *CharacterReputationsSummaryFields) (any, error) {
	...
	if fields.CN != nil {
		...
		if CNHookCharacterReputationsSummary != nil {
			return CNHookCharacterReputationsSummary(ctx, fields)
		}
	...
	objString, err := StringCharacterReputationsSummary(ctx, fields)
	if err != nil {
		return nil, err
	}
