...
// CNHookCharacterProfessionsSummary allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookCharacterProfessionsSummary func(context.Context, *CharacterProfessionsSummaryFields) (any, error)

// StringCharacterProfessionsSummary executes the request and returns the raw response body string.
func StringCharacterProfessionsSummary(ctx context.Context, fields *CharacterProfessionsSummaryFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("CharacterProfessionsSummary")
...
func bridgeCharacterProfessionsSummary(ctx context.Context, fields *CharacterProfessionsSummaryFields) (any, error) {
	...
	objString, err := StringCharacterProfessionsSummary(ctx, fields)
	if err != nil {
		return nil, err
	}
