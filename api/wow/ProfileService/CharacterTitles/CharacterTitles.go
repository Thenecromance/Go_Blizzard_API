...
// CNHookCharacterTitlesSummary allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookCharacterTitlesSummary func(context.Context, *CharacterTitlesSummaryFields) (any, error)

// StringCharacterTitlesSummary executes the request and returns the raw response body string.
func StringCharacterTitlesSummary(ctx context.Context, fields *CharacterTitlesSummaryFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("CharacterTitlesSummary")
...
// bridgeCharacterTitlesSummary routes the request to either CN or Global logic based on input.
func bridgeCharacterTitlesSummary(ctx context.Context, fields *CharacterTitlesSummaryFields) (any, error) {
	...
	if fields.CN != nil {
		...
		if CNHookCharacterTitlesSummary != nil {
			return CNHookCharacterTitlesSummary(ctx, fields)
		}
	...
	objString, err := StringCharacterTitlesSummary(ctx, fields)
	if err != nil {
		return nil, err
	}
