...
func init() {
	CNHookCharacterStatisticsSummary = CNHookCharacterStatisticsSummaryFunc
}

func CNHookCharacterStatisticsSummaryFunc(ctx context.Context, field *CharacterStatisticsSummaryFields) (any, error) {
	cli := &http.Client{}
	...
	var result struct {
		...
		Data    *CNCharacterStatisticsSummaryModel `json:"data,omitempty"`
	}
...
func postProcess(data *CNCharacterStatisticsSummaryModel, field *CharacterStatisticsSummaryFields) *CharacterStatisticsSummaryModel {
	...
	result := data.ToBNet().(*CharacterStatisticsSummaryModel)
