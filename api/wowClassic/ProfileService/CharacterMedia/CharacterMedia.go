...
// CNHookCharacterMediaSummary allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookCharacterMediaSummary func(context.Context, *CharacterMediaSummaryFields) (any, error)

// StringCharacterMediaSummary executes the request and returns the raw response body string.
func StringCharacterMediaSummary(ctx context.Context, fields *CharacterMediaSummaryFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("CharacterMediaSummary")
...
func bridgeCharacterMediaSummary(ctx context.Context, fields *CharacterMediaSummaryFields) (any, error) {
	...
	if fields.CN != nil {
		...
		if CNHookCharacterMediaSummary != nil {
			return CNHookCharacterMediaSummary(ctx, fields)
		}
	...
	objString, err := StringCharacterMediaSummary(ctx, fields)
	if err != nil {
		return nil, err
	}
