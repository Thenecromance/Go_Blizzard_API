...
// ==============================================================================================
// API: CharacterAppearanceSummary
// ==============================================================================================
...
// CNHookCharacterAppearanceSummary allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookCharacterAppearanceSummary func(context.Context, *CharacterAppearanceSummaryFields) (any, error)

// StringCharacterAppearanceSummary executes the request and returns the raw response body string.
func StringCharacterAppearanceSummary(ctx context.Context, fields *CharacterAppearanceSummaryFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("CharacterAppearanceSummary")
...
// bridgeCharacterAppearanceSummary routes the request to either CN or Global logic based on input.
func bridgeCharacterAppearanceSummary(ctx context.Context, fields *CharacterAppearanceSummaryFields) (any, error) {
	...
	if fields.CN != nil {
		...
		if CNHookCharacterAppearanceSummary != nil {
			return CNHookCharacterAppearanceSummary(ctx, fields)
		}
	...
	objString, err := StringCharacterAppearanceSummary(ctx, fields)
	if err != nil {
		return nil, err
	}
