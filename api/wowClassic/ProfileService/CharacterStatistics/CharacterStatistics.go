...
// ==============================================================================================
// API: CharacterStatisticsSummary
// ==============================================================================================
...
// CNHookCharacterStatisticsSummary allows injecting a custom implementation for the CN endpoint.
// Implement this in a separate file (e.g. init()) to handle CN logic without modifying generated code.
var CNHookCharacterStatisticsSummary func(context.Context, *CharacterStatisticsSummaryFields) (any, error)

// StringCharacterStatisticsSummary executes the request and returns the raw response body string.
func StringCharacterStatisticsSummary(ctx context.Context, fields *CharacterStatisticsSummaryFields) (string, error) {
	...
	fields.RequestMethod = utils.GetApiConfig("CharacterStatisticsSummary")
...
// bridgeCharacterStatisticsSummary routes the request to either CN or Global logic based on input.
func bridgeCharacterStatisticsSummary(ctx context.Context, fields *CharacterStatisticsSummaryFields) (any, error) {
	...
	if fields.CN != nil {
		...
		if CNHookCharacterStatisticsSummary != nil {
			return CNHookCharacterStatisticsSummary(ctx, fields)
		}
	...
	objString, err := StringCharacterStatisticsSummary(ctx, fields)
	if err != nil {
		return nil, err
	}
