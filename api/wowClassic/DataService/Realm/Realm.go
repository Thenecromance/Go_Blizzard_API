...
// RealmSearch RealmSearch Performs a search of realms. The fields below are examples only. For more detail see the <a href="/documentation/world-of-warcraft-classic/guides/search">Search Guide</a>.
// Path: /data/wow/search/realm
